import { MPMBGenericProperty, SourceMaterial } from "./CommonAttributes";

const name: MPMBGenericProperty<string> = {
  propertyName: "name",
...
const sortName: MPMBGenericProperty<string> = {
...
const nameAlt: MPMBGenericProperty<string> = {
...
const nameTestString: MPMBGenericProperty<string> = {
...
const nameTestRegExp: MPMBGenericProperty<string> = {
  propertyName: "nameTest",
  example:
...
const source: MPMBGenericProperty<SourceMaterial> = {
  propertyName: "source",
  example: ["HB", 0],
  required: true,
  type: "SourceMaterial",
...
const defaultExcluded: MPMBGenericProperty<boolean> = {
...
const type: MPMBGenericProperty<string> = {
  propertyName: "type",
...
const rarity: MPMBGenericProperty<string> = {
  propertyName: "rarity",
  example: "rare",
  required: true,
  type: "string",
...
const attunement: MPMBGenericProperty<boolean> = {
...
const weight: MPMBGenericProperty<number> = {
  propertyName: "weight",
  example: 12,
  required: false,
  type: "number",
...
const prerequisite: MPMBGenericProperty<string> = {
...
const allowDuplicates: MPMBGenericProperty<boolean> = {
...
const description: MPMBGenericProperty<string> = {
...
const descriptionLong: MPMBGenericProperty<string> = {
...
const descriptionFull: MPMBGenericProperty<string> = {
...
export const MagicItemProperties: MPMBGenericProperty<any>[] = [
  name,
  sortName,
  nameAlt,
  nameTestString,
